    ...
    return (
      <div className="mb-8 flex items-center justify-center py-12">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-zinc-500">Loading group dynamics...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <Card className="card-glass">
          ...
          <CardContent>
            ...
            <p className="text-xs text-zinc-500">Initiates the most chats</p>
          </CardContent>
        </Card>
            ...
            {sorted.map((p, idx) => {
              ...
              return (
                <div key={p.handleId} className="space-y-1">
                  ...
                  {/* Stats row */}
                  <div className="ml-7 flex gap-4 text-[11px] text-zinc-500">
                    <span>
                      Avg length:{" "}
                    ...
                    <span>
                      ...
                      <span
                        className={
                          highIgnored ? "text-red-400" : "text-zinc-400"
                        }
                      >
